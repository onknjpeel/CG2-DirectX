...
#pragma region fence読み込み
	...
	D3D12_CPU_DESCRIPTOR_HANDLE textureSrvHandleCPUFence = GetCPUDescriptorHandle(srvDescriptorHeap, descriptorSizeSRV, 3);
...
#pragma endregion
			...
			commandList->DrawInstanced(UINT(planeData.vertices.size()), 10, 0, 0);
